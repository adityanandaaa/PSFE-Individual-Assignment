"""
DEPRECATED: This file is part of the legacy Tkinter desktop application.
This application has been replaced with a Streamlit web app (web_app.py).

To run the web app:
    streamlit run web_app.py

The Streamlit app provides all the same functionality with a modern web interface.
